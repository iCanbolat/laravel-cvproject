      ...
      <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
        ...
        <div class="row" style="font-weight: bold;">
            <div class="col-md-4  my-auto">
                <h3 class="text-center views">Views</h3><br>

                <h5 class="pt-2 pl-3">Last Week <i class="icofont-long-arrow-right" style="font-size: larger;"></i> <strong></strong></h5>
                <h5 class="pl-3">Last Month <i class="icofont-long-arrow-right" style="font-size: larger;"></i> <strong></strong> </h5>
      ...
      <div class="col-md-12 mt-sm-5 m-lg-0"  >
             <div class="card" id="card">
               ...
               <div class="card my-2 rounded shadow py-3" role="button"  >
                   ...
                   <!-- Edit -->
                       ...
                       <div class="modal fade" id="exampleModal{{ $posts->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            ...
                            <div class="col-md-12 text-center mt-4 " style="font-weight: bold;">
                            <form action="{{route('profile.update',$posts->id)}} " method="POST" enctype="multipart/form-data">
                            @method('PUT')    
                            @csrf
                                    <div class="form-group ">
                                        <label for="exampleFormControlFile1">Company Picture</label>
                   ...
                   <!-- Delete -->
                        <form id="delete" action="{{ route('profile.destroy',$posts->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
